...
int minilib_png_write_to_file(void* pv_image, const char *file, int convert_to_8bit, const void *buffer,
...
int minilib_png_write_to_memory(void* pv_image, void *memory,
